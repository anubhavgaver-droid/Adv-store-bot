...
async def panel_start_settings(client: Client, callback_query: CallbackQuery):
    ...
    spoiler_status = "Bʟᴜʀ Mᴏᴅᴇ: ✅ ON" if is_spoiler else "Bʟᴜʀ Mᴏᴅᴇ: ❌ OFF"
    pic_status = "✅" if start_pic else "❌"
