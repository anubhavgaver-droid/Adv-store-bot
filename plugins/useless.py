...
@Bot.on_message(filters.private & filters.command('dlt_time') & filters.user(OWNER_ID))
...
@Bot.on_message(filters.private & filters.command('check_dlt_time') & filters.user(OWNER_ID))
